...
const TemplateSelector = ({selectedTemplate, onChange}) => {
    ...
    const templates = [
        ...
        },
        {
            ...
            id: "minimal-image",
            name: "Minial Image",
            preview: "Minimal design with a focus on a profile image and essential information."
        },
        {
            id: "minimal",
            name: "Minimal",
            preview: "Simple and elegant layout with plenty of white space and minimal distractions."
        },
    ]
  return (
    <div className='relative'>
        <button
            ...
            className='flex items-center gap-1 text-sm text-blue-600 bg-gradient-to-br from-blue-50 to-blue-100 hover:ring transition-all px-3 py-2 rounded-lg'
        >
            <Layout size={14}/> 
