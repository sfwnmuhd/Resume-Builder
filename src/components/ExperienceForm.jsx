  ...
  return (
    <div className='space-y-6'>
      <div className='flex items-center justify-between'>
        <div>
            <h3 className='flex items-center gap-2 text-lg font-semibold text-gray-900'>Profeesional Experience</h3>
            ...
            {data.map((experience, index) => (
                <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                    ...
                    <div className='grid md:grid-cols-2 gap-3'>
                        ...
                        className='px-3 py-2 text-sm rounded-lg disabled:bg-gray-100 border  border-gray-200 '
                        />
                    </div>
                    ...
                    <div className='space-y-2'>
                        ...
                        <textarea value={experience.description || ""} onChange={(e)=> updateExperience(index, "description", e.target.value)}  rows={4} className='w-full text-sm px-3 py-2  rounded-lg resize-none border  border-gray-200 ' placeholder='Describe your key responsibilities and achievements..'/>
                    </div>
                </div>
            ))}
        </div>
